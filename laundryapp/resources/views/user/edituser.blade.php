        ...
        @method('PUT')
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"  placeholder="city" name="city" value="@if (!empty($data)){{ $data->city }}@else{{ old('city') }}@endif">
                  </div>
                  <div class="form-group">
                    <label for="mobile number">Mobile Number</label>
                    <input type="text" class="form-control"  placeholder="number" name="mob" minlength="10" maxlength="12" value="@if (!empty($data)){{ $data->number}}@else{{ old('number') }}@endif">
                  </div>
                  </div>
                <!-- /.card-body -->
